...
- [Operating at scale](docs/OPERATING_AT_SCALE.md) — pricing, revenue tracking, adoption, when to scale out · [Multi-worker (H2)](docs/MULTIWORKER.md) · [Threat model (H1 prep)](docs/THREAT_MODEL.md)
